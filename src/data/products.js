...
export const CANDLES = [
  ...
  },
  {
    ...
    description: 'Swirl candles are sculptural, hand-poured, or molded soy/coconut wax candles featuring a twisted, spiral, or helical design.',
    tagline: 'Swirl candles are sculptural, hand-poured, or molded soy/coconut wax candles featuring a twisted, spiral, or helical design.',
    ingredients: 'Soy wax, cranberry oil, cotton wick',
    inStock: true,
    stock: 5,
    bestseller: false,
  ...
  },
  {
    ...
    description: 'A teacup candle is a charming decorative item created by pouring scented candle wax—often eco-friendly soy or beeswax—into a vintage or decorative porcelain teacup.',
    tagline: 'A teacup candle is a charming decorative item created by pouring scented candle wax—often eco-friendly soy or beeswax—into a vintage or decorative porcelain teacup.',
    ingredients: 'Soy wax, premium essential oil, cotton wick',
    inStock: true,
    stock: 5,
    bestseller: false,
  ...
  },
  {
    ...
    description: 'Teddy bear candles are charming, hand-poured, molded wax figures designed to add a playful, cozy accent to home décor, acting as perfect gifts for occasions like baby showers, birthdays, or Valentines Day',
    tagline: 'Teddy bear candles are charming, hand-poured, molded wax figures designed to add a playful, cozy accent to home décor, acting as perfect gifts for occasions like baby showers, birthdays, or Valentines Day',
    ingredients: 'Soy wax, premium essential oil, cotton wick',
    inStock: true,
    stock: 5,
    bestseller: false,
  ...
  {
    id: 'c22',
    slug: 'floral-teddy-candle',
    name: 'Floral Teddy Candle',
    category: 'candle',
    price: 180,
    originalPrice: null,
    weight: '150g',
  ...
  },
  {
    ...
    description: 'Tulip candles are handcrafted or molded decorative candles designed to mimic the elegant shape and petals of real tulip flowers.',
    tagline: 'Add a touch of elegance to your space with these beautiful Tulip Bouquet Candles!',
    ingredients: 'Soy wax, premium essential oil, cotton wick',
    inStock: true,
    stock: 5,
    bestseller: false,
