...
const PAYMENT_METHODS = [
  { id: 'upi', label: 'UPI', icon: '⚡', desc: 'Pay via GPay, PhonePe, etc.' },
    ...
    <div key="delivery" className={styles.formSection}>
      ...
      <div className={styles.row}>
        <div className={styles.field}>
          ...
          <input className={styles.input} type="text" value={form.city} readOnly />
        </div>
        <div className={styles.field}>
          <label className={styles.label}>State</label>
          <input className={styles.input} type="text" value={form.state} readOnly />
        </div>
      </div>
    </div>,
      ...
      <div className={styles.container}>
        <header className={styles.header}>
          ...
          <div className={styles.steps}>
            {STEPS.map((s, i) => (
              <span key={s} className={`${styles.stepLabel} ${i <= step ? styles.stepLabelActive : ''}`}>{s}</span>
            ))}
          </div>
        </header>
